...
export default function ShapeSorterPage() {
    return (
        <div className="min-h-screen bg-[#0f172a] text-white overflow-hidden relative font-rubik" dir="rtl">
            ...
            {/* Background - Gentle Green for Calm sorting */}
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-teal-900 via-slate-900 to-black w-full h-full -z-10" />
            ...
            <main className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4">
                ...
                <div className="text-center mb-8 animate-fade-in-up">
                    <h1 className="text-4xl md:text-5xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400 drop-shadow-sm">
                        מיון צורות 🔺
                    </h1>
                    <p className="text-lg text-emerald-200 max-w-lg mx-auto">
                        גררו את הצורות למקום המתאים להן.
                    </p>
                </div>
                ...
                <div className="w-full max-w-5xl animate-scale-in">
                    <ShapeSorterGame
                        onComplete={(stats) => {
                            console.log("Shape Level Complete!", stats);
                        }}
                    />
                </div>
